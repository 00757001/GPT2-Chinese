...
def main(input_sent):
    ...
    parser.add_argument('--length', default=len(input_sent), type=int, required=False, help='生成长度')
    ...
    parser.add_argument('--prefix', default=input_sent, type=str, required=False, help='生成文章的开头')
...
if __name__ == '__main__':
    ...
    file1 = open("test/test_general_1.json", "r", encoding="utf-8")
    data1 = json.load(file1)

    file2 = open("test/test_s2_1.json", "r", encoding="utf-8")
    ...
    with open("test/result_general_1.json", "w", encoding="utf-8") as json_file:
        json.dump(output1, json_file, ensure_ascii=False, indent=2)

    with open("test/result_s2_1.json", "w", encoding="utf-8") as json_file:
